...
export default function BottomNav() {
  ...
  return (
    <nav className="flex items-center justify-center gap-12 py-5 bg-white border-t border-gray-100">
      ...
      <button onClick={() => setScreen('category')} className="flex flex-col items-center gap-1.5 text-gray-500 hover:text-daiso-red transition-colors">
        <div className="w-14 h-14 rounded-2xl bg-gray-100 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
      ...
      <button onClick={() => setScreen('storemap')} className="flex flex-col items-center gap-1.5 text-gray-500 hover:text-daiso-red transition-colors">
        <div className="w-14 h-14 rounded-2xl bg-gray-100 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
      ...
      <button onClick={() => setScreen('help')} className="flex flex-col items-center gap-1.5 text-gray-500 hover:text-daiso-red transition-colors">
        <div className="w-14 h-14 rounded-2xl bg-gray-100 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
